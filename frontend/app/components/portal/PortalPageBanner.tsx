...
export default function PortalPageBanner({ title, subtitle, imageUrl }: Props) {
  return (
    <div className="-mx-8 -mt-24 relative overflow-hidden mb-10" style={{ height: '200px' }}>
      <div
        className="absolute inset-0 bg-cover bg-center scale-105"
        style={{ backgroundImage: `url('${imageUrl}')` }}
      />
      <div className="absolute inset-0 bg-gradient-to-b from-[#133425]/80 via-[#133425]/50 to-[#f5f0e4]" />
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-8 pb-8">
        {subtitle && (
